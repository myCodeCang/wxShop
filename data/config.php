...
$config['db']['master']['host'] = '192.168.0.188';
$config['db']['master']['username'] = 'root';
$config['db']['master']['password'] = 'root';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'qywxshop';
...
$config['setting']['authkey'] = '6983aae6';
$config['setting']['founder'] = '1';
$config['setting']['development'] = 1;    //debug调试开关
