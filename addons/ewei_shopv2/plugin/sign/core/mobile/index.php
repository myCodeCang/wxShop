	...
	public function dosign() 
	{
		...
		if (!(empty($date)) && !(empty($set['signold'])) && (0 < $set['signold_price'])) 
		{
			if (empty($set['signold_type'])) 
			{
				...
				m('member')->setCredit($_W['openid'], 'credit2', -$set['signold_price'], $set['textcredit'] . $set['textsign'] . ': ' . $set['textsignold'] . '扣除' . $set['signold_price'] . $set['textmoney'], 22);
			}
			else 
			{
				...
				m('member')->setCredit($_W['openid'], 'credit1', -$set['signold_price'], $set['textcredit'] . $set['textsign'] . ': ' . $set['textsignold'] . '扣除' . $set['signold_price'] . $set['textcredit'], 22);
			}
		}
