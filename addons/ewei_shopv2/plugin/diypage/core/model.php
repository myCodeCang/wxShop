							...
							if (!(empty($goods)) && !(empty($goods)) && is_array($goods)) 
							{
								foreach ($goods as $index => $good ) 
								{
									...
									if (!(empty($showgoods))) 
									{
										$childid = rand(1000000000, 9999999999);
										$childid = 'C' . $childid;
										$item['data'][$childid] = array('thumb' => $good['thumb'], 'title' => $good['title'], 'price' => $good['minprice'], 'gid' => $good['id'], 'total' => $good['total'], 'bargain' => $good['bargain'], 'salesreal' => $good['salesreal'], 'sales' => $good['sales'], 'productprice' => $good['productprice']);
									}
								}
							}
						}
