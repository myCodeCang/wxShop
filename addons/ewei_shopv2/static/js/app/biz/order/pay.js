define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.pay = function(btn) {
        ...
        if (type == 'wechat') {
            if (core.ish5app()) {
                layui.use(['qyShop'], function(){
                    layui.qyShop.qyWxPay(modal.params.money, '订单支付', modal.params.body, modal.params.ordersn);
                });
            ...
            if (core.ish5app()) {
                layui.use(['qyShop'], function(){
                    layui.qyShop.qyAliPay(modal.params.money, '订单支付', modal.params.body, modal.params.ordersn);
                });
