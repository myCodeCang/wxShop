<?php
require_once IA_ROOT . "/framework/Wxpay/lib/WxPay.Exception.php";
require_once IA_ROOT . "/framework/Wxpay/lib/WxPay.Config.php";
require_once IA_ROOT . "/framework/Wxpay/lib/WxPay.Data.php";
