...
require_once IA_ROOT . "/framework/Wxpay/lib/WxPay.Api.php";
require_once IA_ROOT . "/framework/Wxpay/example/WxPay.NativePay.php";
require_once IA_ROOT . '/framework/Wxpay/example/log.php';
