...
function setting_load($key = '') {
    ...
    $_W['setting']['site']['key'] = empty($_W['setting']['site']['key']) ? random(5, true) : $_W['setting']['site']['key'];
    $_W['setting']['site']['token'] = empty($_W['setting']['site']['token']) ? "ojWRS7m0OX18R1ZxC7M5fgdCyr5tJ629" : $_W['setting']['site']['token'];
	//增加默认值
    return $settings;
}
